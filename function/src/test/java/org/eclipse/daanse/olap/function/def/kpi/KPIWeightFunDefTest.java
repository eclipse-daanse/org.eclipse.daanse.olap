...
class KPIWeightFunDefTest {

    private KPIWeightFunDef funDef;

    @BeforeEach
    void setUp() {
        funDef = new KPIWeightFunDef();
    }

    @Test
    @DisplayName("Should have function name KPIWeight")
    void shouldHaveCorrectFunctionName() {
        assertThat(funDef.getFunctionMetaData().operationAtom().name()).isEqualTo("KPIWeight");
    }
    ...
    @Test
    @DisplayName("Should compile call to KPIWeightCalc")
    void shouldCompileToKPIWeightCalc() {
        ...
        assertThat(result).isInstanceOf(KPIWeightCalc.class);
    }
}
