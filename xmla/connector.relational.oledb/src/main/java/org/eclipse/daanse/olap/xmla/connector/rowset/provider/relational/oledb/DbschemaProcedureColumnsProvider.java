...
/**
 * {@code DBSCHEMA_PROCEDURE_COLUMNS}, as a whiteboard service — <strong>answering no rows
 * yet</strong>.
 * <p>
 * The columns a procedure's rowset returns. One of the OLE DB schema rowsets (Appendix B), which [MS-SSAS] does
...
public class DbschemaProcedureColumnsProvider implements RowsetProvider<ContextListSupplyer> {
