...
public class TupleType implements Type {
    ...
    public List<Hierarchy> getHierarchies() {
        final List<Hierarchy> hierarchies = new ArrayList<>(elementTypes.length);
        for (Type elementType : elementTypes) {
     ...
     * org.eclipse.daanse.olap.api.exception.OlapRuntimeException.
     *
            ...
            for (int j = 0; j < i; j++) {
                ...
                if (hierarchy != null && hierarchy == hierarchy1) {
                    throw new OlapRuntimeException(
                            MessageFormat.format(dupHierarchiesInTuple, hierarchy.getUniqueName()));
                }
            }
        }
    }
