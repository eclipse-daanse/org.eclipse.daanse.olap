...
/**
 * {@code DBSCHEMA_FOREIGN_KEYS}, as a whiteboard service — <strong>answering no rows
 * yet</strong>.
 * <p>
 * The foreign key columns defined in the catalog. One of the OLE DB schema rowsets (Appendix B), which [MS-SSAS] does
 ...
 * knows.
 * <p>
 * <strong>To fill it</strong>, the catalog needs key metadata. The mapping model
...
public class DbschemaForeignKeysProvider implements RowsetProvider<ContextListSupplyer> {
