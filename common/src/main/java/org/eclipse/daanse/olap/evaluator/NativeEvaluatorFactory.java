 ...
 *
 * There exist multiple NativeEvaluatorFactory implementations, e.g. for CrossJoin,
 ...
 */
public abstract class NativeEvaluatorFactory {
     ...
     */
    public abstract NativeEvaluator createEvaluator(
        Evaluator evaluator,
