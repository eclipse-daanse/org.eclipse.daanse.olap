...
public class RangeFunDef extends AbstractFunctionDefinition {
    ...
    static final FunctionMetaData functionMetaData = new FunctionMetaDataR(functionAtom,
            ...
            DataType.SET, new FunctionParameterR[] { FunctionParameterR.param(DataType.MEMBER, "StartMember").describedAs("Start Member"), FunctionParameterR.param(DataType.MEMBER, "EndMember")
                    .describedAs("End Member") }).withTextKey("Colon.Operation").caption("Colon Operation") ;
