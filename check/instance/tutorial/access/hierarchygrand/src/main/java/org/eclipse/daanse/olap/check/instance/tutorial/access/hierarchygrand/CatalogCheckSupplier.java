 ...
 */
package org.eclipse.daanse.olap.check.instance.tutorial.access.hierarchygrand;
...
public class CatalogCheckSupplier implements org.eclipse.daanse.olap.check.model.provider.CatalogCheckSupplier {
    ...
    public OlapCheckModel get() {
        ...
        model.setName("Daanse Tutorial - Access Hierarchy Grant Catalog Checks");
        model.setDescription("Comprehensive checks for Daanse Tutorial - Access Hierarchy Grant catalog - logistics and package delivery analysis");
