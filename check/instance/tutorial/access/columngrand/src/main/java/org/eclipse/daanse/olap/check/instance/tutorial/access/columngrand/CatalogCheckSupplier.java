 ...
 */
package org.eclipse.daanse.olap.check.instance.tutorial.access.columngrand;
...
public class CatalogCheckSupplier implements org.eclipse.daanse.olap.check.model.provider.CatalogCheckSupplier {
    ...
    public OlapCheckModel get() {
        ...
        model.setName("Daanse Tutorial - Access Column Grant Checks");
        model.setDescription("Comprehensive checks for Daanse Tutorial - Access Column Grant catalog");
