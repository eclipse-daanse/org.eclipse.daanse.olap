...
/**
 * {@code DBSCHEMA_STATISTICS}, as a whiteboard service — <strong>answering no rows
 * yet</strong>.
 * <p>
 * The statistics defined in the catalog. One of the OLE DB schema rowsets (Appendix B), which [MS-SSAS] does
 ...
 * knows.
 * <p>
 * <strong>To fill it</strong>, the catalog needs index and cardinality metadata. The mapping model
...
@Component(service = RowsetProvider.class, scope = ServiceScope.PROTOTYPE, property = RowsetProvider.PROPERTY_REQUEST_TYPE
        + "=DBSCHEMA_STATISTICS")
public class DbschemaStatisticsProvider implements RowsetProvider<ContextListSupplyer> {
