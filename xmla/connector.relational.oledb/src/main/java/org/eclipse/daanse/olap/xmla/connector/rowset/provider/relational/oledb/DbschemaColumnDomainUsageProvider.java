...
/**
 * {@code DBSCHEMA_COLUMN_DOMAIN_USAGE}, as a whiteboard service — <strong>answering no rows
 * yet</strong>.
 * <p>
 * The columns that draw their type from a domain. One of the OLE DB schema rowsets (Appendix B), which [MS-SSAS] does
 ...
 * knows.
 * <p>
 * <strong>To fill it</strong>, the catalog needs domain metadata. The mapping model
...
public class DbschemaColumnDomainUsageProvider implements RowsetProvider<ContextListSupplyer> {
