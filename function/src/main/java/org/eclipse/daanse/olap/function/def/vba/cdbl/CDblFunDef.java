...
public class CDblFunDef  extends AbstractFunctionDefinition {
    ...
    static FunctionMetaData functionMetaData = new FunctionMetaDataR(atom, description,
            DataType.NUMERIC, new FunctionParameterR[] { FunctionParameterR.param(DataType.VALUE, "expression").describedAs("Expression") }).withTextKey("CDbl").caption("CDbl Function");
