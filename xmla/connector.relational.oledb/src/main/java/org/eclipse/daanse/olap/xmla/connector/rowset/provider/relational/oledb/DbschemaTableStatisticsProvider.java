...
/**
 * {@code DBSCHEMA_TABLE_STATISTICS}, as a whiteboard service — <strong>answering no rows
 * yet</strong>.
 * <p>
 * The available statistics on the catalog's tables. One of the OLE DB schema rowsets (Appendix B), which [MS-SSAS] does
 ...
 * knows.
 * <p>
 * <strong>To fill it</strong>, the catalog needs cardinality metadata. The mapping model
...
public class DbschemaTableStatisticsProvider implements RowsetProvider<ContextListSupplyer> {
