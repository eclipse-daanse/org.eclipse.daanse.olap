...
public class CovarianceResolver extends AbstractFunctionDefinitionMultiResolver {
    ...
    private static FunctionMetaData functionMetaData = new FunctionMetaDataR(atom, DESCRIPTION,
            DataType.NUMERIC, new FunctionParameterR[] { FunctionParameterR.param(DataType.SET).describedAs("Set"),
                    ...
                    FunctionParameterR.param(DataType.NUMERIC, "Numeric_Expression_X").describedAs("Numeric Expression X")
                            .asOptional() }).interfaceName(FunctionInterface.STATISTICAL)
            .withTextKey("Covariance.Function").caption("Covariance Function");
