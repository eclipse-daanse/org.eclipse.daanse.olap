...
class KPIValueFunDefTest {

    private KPIValueFunDef funDef;

    @BeforeEach
    void setUp() {
        funDef = new KPIValueFunDef();
    }

    @Test
    @DisplayName("Should have function name KPIValue")
    void shouldHaveCorrectFunctionName() {
        assertThat(funDef.getFunctionMetaData().operationAtom().name()).isEqualTo("KPIValue");
    }
    ...
    @Test
    @DisplayName("Should compile call to KPIValueCalc")
    void shouldCompileToKPIValueCalc() {
        ...
        assertThat(result).isInstanceOf(KPIValueCalc.class);
    }
}
