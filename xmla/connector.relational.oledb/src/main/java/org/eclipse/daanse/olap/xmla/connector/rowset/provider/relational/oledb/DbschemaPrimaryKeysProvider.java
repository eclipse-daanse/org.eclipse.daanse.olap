...
/**
 * {@code DBSCHEMA_PRIMARY_KEYS}, as a whiteboard service — <strong>answering no rows
 * yet</strong>.
 * <p>
 * The primary key columns defined in the catalog. One of the OLE DB schema rowsets (Appendix B), which [MS-SSAS] does
...
public class DbschemaPrimaryKeysProvider implements RowsetProvider<ContextListSupplyer> {
