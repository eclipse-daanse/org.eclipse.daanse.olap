...
import org.eclipse.daanse.xmla.model.csdl.v2.bi.TEntitySet;
import org.eclipse.daanse.xmla.model.csdl.v2.edm.EntityContainerType;
import org.eclipse.daanse.xmla.model.csdl.v2.edm.EntitySetType;
...
/**
 * One EDM entity type per dimension, with a property per level and per member
 * property.
 */
public class DimensionEntityEmitter {

    void emitDimensionEntity(TSchema schema, EntityContainerType container, Cube cube, Dimension dim, EmitContext ctx) {
