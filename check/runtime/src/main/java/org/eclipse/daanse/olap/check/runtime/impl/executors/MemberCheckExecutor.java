...
public class MemberCheckExecutor {
    ...
    public MemberCheckExecutor(MemberCheck check, List<Member> members, Cube cube, CatalogReader catalogReader,
    ...
    private PropertyCheckResult executePropertyCheck(PropertyCheck propertyCheck, Member member) {
        ...
        try {
            ...
            boolean matches = AttributeCheckHelper.compareValues(expectedValue, actualValue,
                    propertyCheck.getMatchMode(), propertyCheck.isCaseSensitive());
            result.setStatus(matches ? CheckStatus.SUCCESS : CheckStatus.FAILURE);
