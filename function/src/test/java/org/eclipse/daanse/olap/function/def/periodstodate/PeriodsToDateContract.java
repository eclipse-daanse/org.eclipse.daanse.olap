 ...
 * Numeric} argument (e.g. {@code PeriodsToDate([Time].[All Time].[2023], 5)}) match at cost 0 and then
...
public final class PeriodsToDateContract {
    ...
    public static final FunctionContract CONTRACT = FunctionContract.of("PeriodsToDate")
            ...
            .edgeCaseMdx("level and member",
                    "PeriodsToDate([Time].[Quarter], [Time].[All Time].[2023].[Q2])")
            ...
            .value("Count(PeriodsToDate([Time].[Quarter], [Time].[All Time].[2023].[Q2]))", "1")

            .dependsOn("PeriodsToDate([Time].[Quarter], [Time].[All Time].[2023].[Q2])")
            .dependsOn("PeriodsToDate()", "[Time]")

            .resultStyle("PeriodsToDate([Time].[Quarter], [Time].[All Time].[2023].[Q2])", MUTABLE_LIST, MUTABLE_LIST)
            .resultStyle("PeriodsToDate([Time].[Quarter], [Time].[All Time].[2023].[Q2])", ITERABLE, MUTABLE_LIST)
            .independentMutableList("PeriodsToDate([Time].[Quarter], [Time].[All Time].[2023].[Q2])")
