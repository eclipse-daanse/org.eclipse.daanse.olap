...
/**
 * {@code DBSCHEMA_COLUMN_PRIVILEGES}, as a whiteboard service — <strong>answering no rows
 * yet</strong>.
 * <p>
 * The column privileges granted to and by a given user. One of the OLE DB schema rowsets (Appendix B), which [MS-SSAS] does
 ...
 * knows.
 * <p>
 * <strong>To fill it</strong>, the catalog needs grant metadata. The mapping model
...
public class DbschemaColumnPrivilegesProvider implements RowsetProvider<ContextListSupplyer> {
