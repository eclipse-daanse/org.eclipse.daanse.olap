...
/**
 * {@code DISCOVER_XML_METADATA}, as a whiteboard service.
 * <p>
 * The database's object definitions as one XML document, shaped by
 * ObjectExpansion and the other restrictions.
 * <p>
...
public class DiscoverXmlMetadataProvider implements RowsetProvider<ContextListSupplyer> {

    @Override
    public List<EObject> rows(RowsetScope<ContextListSupplyer> scope) {
        return new OtherDiscover(scope.backend()).xmlMetaData(scope.restrictions(), scope.caller());
    }
}
