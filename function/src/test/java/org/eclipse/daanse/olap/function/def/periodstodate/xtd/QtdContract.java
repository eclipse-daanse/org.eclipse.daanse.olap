...
public final class QtdContract {
    ...
    public static final FunctionContract CONTRACT = FunctionContract.of("Qtd")
            ...
            .edgeCaseMdx("quarter-level member", "Qtd([Time].[All Time].[2023].[Q2])")
            .edgeCaseMdx("member NULL",          "Qtd(NULL)")

            .value("Count(Qtd([Time].[All Time].[2023].[Q2]))", "1")

            .dependsOn("Qtd([Time].[All Time].[2023].[Q2])")
            .dependsOn("Qtd()", "[Time]")

            .resultStyle("Qtd([Time].[All Time].[2023].[Q2])", MUTABLE_LIST, MUTABLE_LIST)
            .resultStyle("Qtd([Time].[All Time].[2023].[Q2])", ITERABLE, MUTABLE_LIST)
            .independentMutableList("Qtd([Time].[All Time].[2023].[Q2])")
