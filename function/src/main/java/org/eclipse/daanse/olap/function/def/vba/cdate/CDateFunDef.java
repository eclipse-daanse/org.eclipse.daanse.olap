...
public class CDateFunDef  extends AbstractFunctionDefinition {
    ...
    static FunctionMetaData functionMetaData = new FunctionMetaDataR(atom, description,
            DataType.DATE_TIME, new FunctionParameterR[] { FunctionParameterR.param(DataType.VALUE, "Expression").describedAs("Expression") }).withTextKey("CDate").caption("CDate Function");
