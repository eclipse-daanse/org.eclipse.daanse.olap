...
public class AttributeCheckHelper {
    ...
    public static boolean compareValues(String expected, String actual, MatchMode matchMode, boolean caseSensitive) {
        ...
        case CONTAINS ->
            caseSensitive ? actual.contains(expected) : actual.toLowerCase().contains(expected.toLowerCase());
        case STARTS_WITH ->
            caseSensitive ? actual.startsWith(expected) : actual.toLowerCase().startsWith(expected.toLowerCase());
        case ENDS_WITH ->
            caseSensitive ? actual.endsWith(expected) : actual.toLowerCase().endsWith(expected.toLowerCase());
