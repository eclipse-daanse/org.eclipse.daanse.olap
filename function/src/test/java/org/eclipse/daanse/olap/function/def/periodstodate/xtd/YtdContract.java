...
public final class YtdContract {
    ...
    public static final FunctionContract CONTRACT = FunctionContract.of("Ytd")
            ...
            .edgeCaseMdx("year-level member",   "Ytd([Time].[All Time].[2023])")
            .edgeCaseMdx("member NULL",         "Ytd(NULL)")

            .value("Count(Ytd([Time].[All Time].[2023]))", "1")

            .dependsOn("Ytd([Time].[All Time].[2023])")
            .dependsOn("Ytd()", "[Time]")

            .resultStyle("Ytd([Time].[All Time].[2023])", MUTABLE_LIST, MUTABLE_LIST)
            .resultStyle("Ytd([Time].[All Time].[2023])", ITERABLE, MUTABLE_LIST)
            .independentMutableList("Ytd([Time].[All Time].[2023])")
