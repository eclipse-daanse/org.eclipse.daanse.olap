...
/**
 * {@code DBSCHEMA_PROCEDURES}, as a whiteboard service — <strong>answering no rows
 * yet</strong>.
 * <p>
 * The procedures defined in the catalog. One of the OLE DB schema rowsets (Appendix B), which [MS-SSAS] does
...
@Component(service = RowsetProvider.class, scope = ServiceScope.PROTOTYPE, property = RowsetProvider.PROPERTY_REQUEST_TYPE
        + "=DBSCHEMA_PROCEDURES")
public class DbschemaProceduresProvider implements RowsetProvider<ContextListSupplyer> {
