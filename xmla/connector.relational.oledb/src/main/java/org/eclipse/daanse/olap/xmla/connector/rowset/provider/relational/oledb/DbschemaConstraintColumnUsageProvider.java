...
/**
 * {@code DBSCHEMA_CONSTRAINT_COLUMN_USAGE}, as a whiteboard service — <strong>answering no rows
 * yet</strong>.
 * <p>
 * The columns a constraint is defined over. One of the OLE DB schema rowsets (Appendix B), which [MS-SSAS] does
...
public class DbschemaConstraintColumnUsageProvider implements RowsetProvider<ContextListSupplyer> {
