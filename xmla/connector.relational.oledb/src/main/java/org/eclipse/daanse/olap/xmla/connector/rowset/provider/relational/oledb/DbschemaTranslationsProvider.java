...
/**
 * {@code DBSCHEMA_TRANSLATIONS}, as a whiteboard service — <strong>answering no rows
 * yet</strong>.
 * <p>
 * The character translations the catalog can use. One of the OLE DB schema rowsets (Appendix B), which [MS-SSAS] does
 ...
 * knows.
 * <p>
 * <strong>To fill it</strong>, the catalog needs translation metadata. The mapping model
...
public class DbschemaTranslationsProvider implements RowsetProvider<ContextListSupplyer> {
