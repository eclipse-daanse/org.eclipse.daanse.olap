...
public class CByteFunDef  extends AbstractFunctionDefinition {
    ...
    static FunctionMetaData functionMetaData = new FunctionMetaDataR(atom, description,
            DataType.INTEGER, new FunctionParameterR[] { FunctionParameterR.param(DataType.VALUE, "Expression").describedAs("Expression") }).withTextKey("CByte").caption("CByte Function");
