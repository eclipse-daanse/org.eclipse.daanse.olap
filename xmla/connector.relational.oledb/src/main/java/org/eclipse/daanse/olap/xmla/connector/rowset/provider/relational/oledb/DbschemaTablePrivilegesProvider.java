...
/**
 * {@code DBSCHEMA_TABLE_PRIVILEGES}, as a whiteboard service — <strong>answering no rows
 * yet</strong>.
 * <p>
 * The table privileges granted to and by a given user. One of the OLE DB schema rowsets (Appendix B), which [MS-SSAS] does
...
public class DbschemaTablePrivilegesProvider implements RowsetProvider<ContextListSupplyer> {
