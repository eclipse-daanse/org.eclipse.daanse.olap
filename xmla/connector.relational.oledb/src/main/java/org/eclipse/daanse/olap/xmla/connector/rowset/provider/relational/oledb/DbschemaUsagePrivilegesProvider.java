...
/**
 * {@code DBSCHEMA_USAGE_PRIVILEGES}, as a whiteboard service — <strong>answering no rows
 * yet</strong>.
 * <p>
 * The usage privileges granted to and by a given user. One of the OLE DB schema rowsets (Appendix B), which [MS-SSAS] does
...
public class DbschemaUsagePrivilegesProvider implements RowsetProvider<ContextListSupplyer> {
