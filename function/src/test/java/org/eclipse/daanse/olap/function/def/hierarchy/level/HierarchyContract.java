...
public final class HierarchyContract {
    ...
    public static final FunctionContract CONTRACT = FunctionContract.of("Hierarchy")
            ...
            .autoEdgeCases()
            .edgeCaseMdx("level reference",               "[Geo].[All Geo].[North].Level.Hierarchy")
            .edgeCaseMdx("member reference",               "[Geo].[All Geo].[North].Hierarchy")
            .edgeCaseMdx("hierarchy/dimension reference",  "[Geo].Hierarchy")

            .value("([Geo].[All Geo].[North].Hierarchy IS [Geo].Hierarchy)", "true")
            .value("([Geo].[All Geo].[North].Level.Hierarchy IS [Geo].Hierarchy)", "true")

            .dependsOn("[Geo].[All Geo].[North].Hierarchy")
            .dependsOn("[Geo].[All Geo].[North].Level.Hierarchy")
