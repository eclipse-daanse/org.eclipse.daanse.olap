...
/**
 * {@code DBSCHEMA_TABLE_CONSTRAINTS}, as a whiteboard service — <strong>answering no rows
 * yet</strong>.
 * <p>
 * The table constraints defined in the catalog. One of the OLE DB schema rowsets (Appendix B), which [MS-SSAS] does
...
public class DbschemaTableConstraintsProvider implements RowsetProvider<ContextListSupplyer> {
