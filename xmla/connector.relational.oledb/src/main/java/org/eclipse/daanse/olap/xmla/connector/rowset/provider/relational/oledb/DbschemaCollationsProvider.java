...
/**
 * {@code DBSCHEMA_COLLATIONS}, as a whiteboard service — <strong>answering no rows
 * yet</strong>.
 * <p>
 * The character collations the catalog can use. One of the OLE DB schema rowsets (Appendix B), which [MS-SSAS] does
 ...
 * knows.
 * <p>
 * <strong>To fill it</strong>, the catalog needs the connection's collation, which the dialect knows. The mapping model
...
@Component(service = RowsetProvider.class, scope = ServiceScope.PROTOTYPE, property = RowsetProvider.PROPERTY_REQUEST_TYPE
        + "=DBSCHEMA_COLLATIONS")
public class DbschemaCollationsProvider implements RowsetProvider<ContextListSupplyer> {
