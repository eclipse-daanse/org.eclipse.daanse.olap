...
public class Atan2FunDef  extends AbstractFunctionDefinition {
    ...
    static FunctionMetaData functionMetaData = new FunctionMetaDataR(atom, description,
            DataType.NUMERIC, new FunctionParameterR[] { FunctionParameterR.param(DataType.NUMERIC, "XNum").describedAs("X-coordinate of the point"), FunctionParameterR.param(DataType.NUMERIC, "YNum").describedAs("Y-coordinate of the point") }).withTextKey("Atan2").caption("Atan2 Function");
