...
/**
 * {@code DBSCHEMA_CHECK_CONSTRAINTS}, as a whiteboard service — <strong>answering no rows
 * yet</strong>.
 * <p>
 * The check constraints defined in the catalog. One of the OLE DB schema rowsets (Appendix B), which [MS-SSAS] does
...
public class DbschemaCheckConstraintsProvider implements RowsetProvider<ContextListSupplyer> {
