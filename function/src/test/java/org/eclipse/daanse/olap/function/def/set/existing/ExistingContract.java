...
public final class ExistingContract {
    ...
    public static final FunctionContract CONTRACT = FunctionContract.of("Existing")
            ...
            .edgeCaseMdx("full set",    "EXISTING [Geo].Members")
            .edgeCaseMdx("single member", "EXISTING {[Geo].[All Geo].[North]}")
            ...
            .value("Count(EXISTING [Geo].Members)", "8")
            .value("SetToStr(EXISTING [Geo].Members)", "{[Geo].[All Geo], [Geo].[All Geo].[North], "
            ...
            .dependsOn("EXISTING [Geo].Members", "[Geo]")

            .resultStyle("EXISTING [Geo].Members", ResultStyle.MUTABLE_LIST, ResultStyle.MUTABLE_LIST)
            .resultStyle("EXISTING [Geo].Members", ResultStyle.ITERABLE, ResultStyle.MUTABLE_LIST)
            .independentMutableList("EXISTING [Geo].Members")
