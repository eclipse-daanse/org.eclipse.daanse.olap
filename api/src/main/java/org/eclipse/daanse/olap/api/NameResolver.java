...
public interface NameResolver {
     ...
     * @param segments       Exploded compound name, such as {"Products", "Product
     *                       Department", "Produce"}
    ...
    public interface Namespace {
         ...
         *
         * If {@code matchType} is MatchType#EXACT, effect is identical to calling
         * #lookupChild(OlapElement,
         * org.eclipse.daanse.olap.api.olap4j.mdx.IdentifierSegment).
         *
         ...
         */
        OlapElement lookupChild(OlapElement parent, IdentifierSegment segment, MatchType matchType);
