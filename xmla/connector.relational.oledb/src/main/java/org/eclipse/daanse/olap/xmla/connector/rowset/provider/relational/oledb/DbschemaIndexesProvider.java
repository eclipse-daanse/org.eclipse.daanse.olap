...
/**
 * {@code DBSCHEMA_INDEXES}, as a whiteboard service — <strong>answering no rows
 * yet</strong>.
 * <p>
 * The indexes defined in the catalog. One of the OLE DB schema rowsets (Appendix B), which [MS-SSAS] does
 ...
 * knows.
 * <p>
 * <strong>To fill it</strong>, the catalog needs index metadata. The mapping model
...
@Component(service = RowsetProvider.class, scope = ServiceScope.PROTOTYPE, property = RowsetProvider.PROPERTY_REQUEST_TYPE
        + "=DBSCHEMA_INDEXES")
public class DbschemaIndexesProvider implements RowsetProvider<ContextListSupplyer> {
