...
public final class LeadContract {
    ...
    public static final FunctionContract CONTRACT = FunctionContract.of("Lead")
            ...
            .value("([Geo].[All Geo].[North].Lead(0) IS [Geo].[All Geo].[North])", "true")
            .value("([Geo].[All Geo].[North].Lead(1) IS [Geo].[All Geo].[South])", "true")
            .value("([Geo].[All Geo].[South].Lead(-1) IS [Geo].[All Geo].[North])", "true")

            .dependsOn("[Geo].[All Geo].[North].Lead(1)")
