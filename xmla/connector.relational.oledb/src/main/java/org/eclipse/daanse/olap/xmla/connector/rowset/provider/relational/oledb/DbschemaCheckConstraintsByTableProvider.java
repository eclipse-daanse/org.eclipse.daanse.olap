...
/**
 * {@code DBSCHEMA_CHECK_CONSTRAINTS_BY_TABLE}, as a whiteboard service — <strong>answering no rows
 * yet</strong>.
 * <p>
 * The check constraints of each table. One of the OLE DB schema rowsets (Appendix B), which [MS-SSAS] does
...
public class DbschemaCheckConstraintsByTableProvider implements RowsetProvider<ContextListSupplyer> {
