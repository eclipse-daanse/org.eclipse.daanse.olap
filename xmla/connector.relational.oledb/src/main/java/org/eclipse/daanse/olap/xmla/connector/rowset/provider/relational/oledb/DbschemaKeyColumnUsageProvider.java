...
/**
 * {@code DBSCHEMA_KEY_COLUMN_USAGE}, as a whiteboard service — <strong>answering no rows
 * yet</strong>.
 * <p>
 * The columns constrained as keys. One of the OLE DB schema rowsets (Appendix B), which [MS-SSAS] does
...
public class DbschemaKeyColumnUsageProvider implements RowsetProvider<ContextListSupplyer> {
