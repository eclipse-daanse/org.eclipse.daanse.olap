 ...
 *
 * <p>
 * This exception indicates that a value could not be converted to the expected
 * target type during the compilation or evaluation of an MDX expression.
 * </p>
 */
...
public class TypeConversionException extends OlapRuntimeException {
    ...
    public static TypeConversionException cannotConvert(Object value, String targetType) {
        ...
        return new TypeConversionException("Cannot convert %s to %s".formatted(valueType, targetType));
    }
}
