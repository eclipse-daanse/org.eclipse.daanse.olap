 ...
 * and tuple lists.
 *
 * <b>NOTE</b>: Like other classes in the org.olap4j.impl package, this class
...
public class IdentifierParser {
     ...
     * of segments.
     *
     * For example, parseIdentifierList("{foo.bar, baz}") returns
     * { {"foo", "bar"}, {"baz"} }.
     *
     * The braces around the list are optional;
     ...
     * member or tuple.
     *
     * Implementations might create a list of members or just create a list
     * of unresolved names.
     */
    public interface Builder {
         ...
         *
         * For example, the identifier {@code [Time].1997.[Jan].&31} contains
