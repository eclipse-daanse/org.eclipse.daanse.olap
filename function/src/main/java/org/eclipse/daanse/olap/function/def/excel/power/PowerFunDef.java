...
public class PowerFunDef  extends AbstractFunctionDefinition {
    ...
    static FunctionMetaData functionMetaData = new FunctionMetaDataR(atom, description,
            DataType.NUMERIC, new FunctionParameterR[] { FunctionParameterR.param(DataType.NUMERIC, "Base").describedAs("Base"), FunctionParameterR.param(DataType.NUMERIC, "Exponent").describedAs("Exponent") }).withTextKey("Power").caption("Power Function");
