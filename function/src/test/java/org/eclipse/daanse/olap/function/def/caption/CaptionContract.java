 ...
 */
package org.eclipse.daanse.olap.function.def.caption;
...
public final class CaptionContract {
    ...
    public static final FunctionContract CONTRACT = FunctionContract.of("Caption")
            ...
            .autoEdgeCases()
            .edgeCaseMdx("hierarchy/dimension reference", "[Geo].Caption")
            .edgeCaseMdx("member reference",               "[Geo].[All Geo].[North].Caption")
            .edgeCaseMdx("level reference",                "[Geo].[All Geo].[North].Level.Caption")
            ...
            .scalarDependsOn("[Geo].[All Geo].[North].Caption")
            .scalarDependsOn("[Geo].[All Geo].[North].Level.Caption")

            // A scalar call has no set to shape. That it answers VALUE was asserted in
            // prose here and never checked, so it is a case now.
            .scalarResultStyle("[Geo].[All Geo].[North].Caption")
