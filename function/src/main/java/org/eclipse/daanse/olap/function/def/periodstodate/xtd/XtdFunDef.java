...
public class XtdFunDef extends AbstractFunctionDefinition {
	...
	public Type getResultType(Validator validator, Expression[] args) {
		...
		// A NULL literal belongs to no dimension, so asking it for one and then for that
		// dimension's type used to end validation with a NullPointerException. The argument
		// is wrong in exactly the way this message already describes.
		if (type.getDimension() == null
				|| type.getDimension().getDimensionType() != DimensionType.TIME_DIMENSION) {
