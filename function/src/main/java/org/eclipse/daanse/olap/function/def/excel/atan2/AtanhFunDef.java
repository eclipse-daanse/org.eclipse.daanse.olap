...
public class AtanhFunDef  extends AbstractFunctionDefinition {
    ...
    static FunctionMetaData functionMetaData = new FunctionMetaDataR(atom, description,
            DataType.NUMERIC, new FunctionParameterR[] { FunctionParameterR.param(DataType.NUMERIC, "Number").describedAs("Numeric Expression") }).withTextKey("Atanh").caption("Atanh Function");
