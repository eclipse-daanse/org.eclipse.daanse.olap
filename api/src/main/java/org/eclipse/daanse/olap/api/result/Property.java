...
public interface Property {
    ...
    /**
     * Enumeration of aspects of the type of a Property. In particular, whether it
     * belongs to a member or a cell.
     *
     * The values are as specified by XMLA for the PROPERTY_TYPE attribute of the
     * MDSCHEMA_PROPERTIES data set. For example, XMLA specifies that the value 9
     * (0x1 | 0x8) means that a property belongs to a member and is a binary large
     * object (BLOB). In this case, Property#getType will return the Set} { #MEMBER,
     * #BLOB}.
     */
    enum TypeFlag {
        /**
         * Identifies a property of a member. This property can be used in the DIMENSION
         * PROPERTIES clause of the SELECT statement.
         */
        MEMBER(1),

        /**
         * Identifies a property of a cell. This property can be used in the CELL
         * PROPERTIES clause that occurs at the end of the SELECT statement.
         */
        CELL(2),
        ...
        public static final Set<Property.TypeFlag> CELL_TYPE_FLAG = Set.of(Property.TypeFlag.CELL);
        public static final Set<Property.TypeFlag> MEMBER_TYPE_FLAG = Set.of(Property.TypeFlag.MEMBER);
     ...
     *
     * The following properties are mandatory for members: #CATALOG_NAME
     * #SCHEMA_NAME #CUBE_NAME #DIMENSION_UNIQUE_NAME #HIERARCHY_UNIQUE_NAME
     * #LEVEL_UNIQUE_NAME #LEVEL_NUMBER #MEMBER_UNIQUE_NAME #MEMBER_NAME
     * #MEMBER_TYPE #MEMBER_GUID #MEMBER_CAPTION #MEMBER_ORDINAL
     * #CHILDREN_CARDINALITY #PARENT_LEVEL #PARENT_UNIQUE_NAME #PARENT_COUNT
     * #DESCRIPTION
     *
     */
    enum StandardMemberProperty implements Property {
         ...
         */
        CATALOG_NAME(Datatype.STRING, false, null,
         ...
         */
        SCHEMA_NAME(Datatype.STRING, false, null,
         ...
         */
        CUBE_NAME(Datatype.STRING, false, null, "Required. Name of the cube to which this member belongs."),

        /**
         * Definition of the property which holds the unique name of the current
         * dimension.
         */
        DIMENSION_UNIQUE_NAME(Datatype.STRING, false, null,
         ...
         * hierarchy.
         */
        HIERARCHY_UNIQUE_NAME(Datatype.STRING, false, null,
         ...
         */
        LEVEL_UNIQUE_NAME(Datatype.STRING, false, null,
         ...
         */
        LEVEL_NUMBER(Datatype.UNSIGNED_INTEGER, false, null,
         ...
         */
        MEMBER_ORDINAL(Datatype.UNSIGNED_INTEGER, false, null,
         ...
         */
        MEMBER_NAME(Datatype.STRING, false, null, "Required. Name of the member."),

        /**
         * Definition of the property which holds the unique name of the current member.
         */
        MEMBER_UNIQUE_NAME(Datatype.STRING, false, null,
         ...
         */
        MEMBER_TYPE(Datatype.STRING, false, null,
                "Required. Type of the member. Can be one of the following values: "
                        ...
                        + "Measures dimension, it is listed as " + "MDMEMBER_Datatype.TYPE_FORMULA."),

        /**
         * Definition of the property which holds the GUID of the member
         */
        MEMBER_GUID(Datatype.STRING, false, null, "Optional. Member GUID. NULL if no GUID exists."),
         ...
         */
        MEMBER_CAPTION(Datatype.STRING, false, null,
         ...
         * has.
         */
        CHILDREN_CARDINALITY(Datatype.UNSIGNED_INTEGER, false, null,
         ...
         */
        PARENT_LEVEL(Datatype.UNSIGNED_INTEGER, false, null,
         ...
         * Definition of the property which holds the Name of the current catalog.
         */
        PARENT_UNIQUE_NAME(Datatype.STRING, false, null,
         ...
         */
        PARENT_COUNT(Datatype.UNSIGNED_INTEGER, false, null, "Required. Number of parents that this member has."),

        /**
         * Definition of the property which holds the description of this member.
         */
        DESCRIPTION(Datatype.STRING, false, null, "Optional. A human-readable description of the member."),
         ...
         */
        $visible(Datatype.BOOLEAN, true, null, null),

        /**
         * Definition of the internal property which holds the value of the member key
         * in the original data type. MEMBER_KEY is for backward-compatibility.
         * MEMBER_KEY has the same value as KEY0 for non-composite keys, and MEMBER_KEY
         * property is null for composite keys.
         */
        MEMBER_KEY(Datatype.VARIANT, true, null, "Optional. The value of the member key. Null for composite keys."),

        /**
         * Definition of the boolean property that indicates whether a member is a
         * placeholder member for an empty position in a dimension hierarchy.
         */
        IS_PLACEHOLDERMEMBER(Datatype.BOOLEAN, false, null,
                "Required. Whether the member is a placeholder member for an empty "
                        + "position in a dimension hierarchy."),

        /**
         * Definition of the property that indicates whether the member is a data
         * member.
         */
        IS_DATAMEMBER(Datatype.BOOLEAN, false, null, "Required. whether the member is a data member"),
         ...
         */
        DEPTH(Datatype.UNSIGNED_INTEGER, true, null, "The level depth of a member"),
         ...
         * so its value is dynamic at runtime.
         */
        DISPLAY_INFO(Datatype.UNSIGNED_INTEGER, false, null, "Display instruction of a member for XML/A"),
         ...
         */
        VALUE(Datatype.VARIANT, false, null, "The unformatted value of the cell.");

        private final Datatype type;
        private final String description;
        private final boolean internal;

        private StandardMemberProperty(Datatype type, boolean internal, Class<? extends Enum> enumClazz,
                String description) {
//            assert ordinal == ordinal();
    ...
    /**
     * Enumeration of the system properties available for every org.olap4j.Cell.
     *
     * The following propertiess are mandatory for cells: #BACK_COLOR
     * #CELL_EVALUATION_LIST #CELL_ORDINAL #FORE_COLOR #FONT_NAME #FONT_SIZE
     * #FONT_FLAGS #FORMAT_STRING #FORMATTED_VALUE #NON_EMPTY_BEHAVIOR #SOLVE_ORDER
     * #VALUE
     *
     */
    enum StandardCellProperty implements Property {
        BACK_COLOR(Datatype.STRING, false,
        ...
        CELL_EVALUATION_LIST(Datatype.STRING, false,
        ...
        CELL_ORDINAL(Datatype.UNSIGNED_INTEGER, false, "The ordinal number of the cell in the dataset."),

        FORE_COLOR(Datatype.STRING, false,
                "The foreground color for displaying the VALUE or FORMATTED_VALUE "
                        + "property. For more information, see FORE_COLOR and BACK_COLOR " + "Contents."),

        FONT_NAME(Datatype.STRING, false, "The font to be used to display the VALUE or FORMATTED_VALUE " + "property."),

        FONT_SIZE(Datatype.STRING, false,
                "Font size to be used to display the VALUE or FORMATTED_VALUE " + "property."),

        FONT_FLAGS(Datatype.UNSIGNED_INTEGER, false, "The bitmask detailing effects on the font. The value is the "
                ...
                + "5 represents the combination of bold (MDFF_BOLD) and underline " + "(MDFF_UNDERLINE) font effects."),

        /**
         * Definition of the property which holds the formatted value of a cell.
         */
        FORMATTED_VALUE(Datatype.STRING, false,
         ...
         */
        SOLVE_ORDER(Datatype.INTEGER, false, "The solve order of the cell."),

        /**
         * Definition of the property which holds the value of a cell. Is usually
         * numeric (since most measures are numeric) but is occasionally another type.
         */
        VALUE(Datatype.VARIANT, false, "The unformatted value of the cell."),
         ...
         */
        DATATYPE(Datatype.STRING, false, "The datatype of the cell."),

        LANGUAGE(Datatype.UNSIGNED_INTEGER, false,
                "The locale where the FORMAT_STRING will be applied. LANGUAGE is "
                        + "usually used for currency conversion."),

        ACTION_TYPE(Datatype.INT4, false, "A bitmask that indicates which types of actions exist on the " + "cell."),

        UPDATEABLE(Datatype.UNSIGNED_INTEGER, false, "A value that indicates whether the cell can be updated.");
        ...
        private StandardCellProperty(Datatype type, boolean internal, String description) {
            this.type = type;
            this.internal = internal;
            this.description = description;
        }
