...
/**
 * {@code DBSCHEMA_CONSTRAINT_TABLE_USAGE}, as a whiteboard service — <strong>answering no rows
 * yet</strong>.
 * <p>
 * The tables a constraint is defined over. One of the OLE DB schema rowsets (Appendix B), which [MS-SSAS] does
...
public class DbschemaConstraintTableUsageProvider implements RowsetProvider<ContextListSupplyer> {
