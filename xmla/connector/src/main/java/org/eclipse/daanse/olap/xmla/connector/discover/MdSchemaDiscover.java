...
public class MdSchemaDiscover {
    ...
    public List<EObject> actions(RestrictionValues restrictions, XmlaRequest caller) {
        ...
        for (Catalog catalog : catalogs(catalogName, caller)) {
    ...
    private static EObject hierarchyRow(CatalogReader reader, Cube cube, String catalogName, Dimension dimension,
        ...
        if (description == null) {
            description = cube.getName() + " Cube - " + hierarchyName(hierarchy.getName(), dimension.getName())
                    + " Hierarchy";
        }
    ...
    /**
     * The bridge's naming rule: a hierarchy not named like its dimension is
     * qualified.
     */
    ...
    private static EObject levelRow(Cube cube, String catalogName, String dimensionUniqueName, Hierarchy hierarchy,
        ...
        if (description == null) {
            description = cube.getName() + " Cube - " + hierarchyName(hierarchy.getName(), dimensionUniqueName)
    ...
    private static EObject memberPropertyRow(String catalogName, Cube cube, Level level,
        ...
        Hierarchy hierarchy = level.getHierarchy();
        Dimension dimension = hierarchy.getDimension();
        String description = cube.getName() + " Cube - " + hierarchyName(hierarchy.getName(), dimension.getName())
     ...
     * otherwise.
     */
    List<Catalog> catalogs(Optional<String> catalogName, XmlaRequest caller) {
