...
/**
 * {@code DBSCHEMA_REFERENTIAL_CONSTRAINTS}, as a whiteboard service — <strong>answering no rows
 * yet</strong>.
 * <p>
 * The referential constraints defined in the catalog. One of the OLE DB schema rowsets (Appendix B), which [MS-SSAS] does
 ...
 * knows.
 * <p>
 * <strong>To fill it</strong>, the catalog needs constraint metadata. The mapping model
...
public class DbschemaReferentialConstraintsProvider implements RowsetProvider<ContextListSupplyer> {
