...
public class ToggleDrillStateResolver extends AbstractFunctionDefinitionMultiResolver {
    ...
    private static FunctionParameterR[] xxy = { FunctionParameterR.param(DataType.SET, "Set").describedAs("Set whose drill state is toggled"),
            FunctionParameterR.param(DataType.SET, "DrilldownSet").describedAs("Set of members whose drill state is toggled"),
    ...
    private static FunctionMetaData functionMetaData = new FunctionMetaDataR(atom, DESCRIPTION, DataType.SET,
            xxy).withTextKey("ToggleDrillState.Function").caption("ToggleDrillState Function");
