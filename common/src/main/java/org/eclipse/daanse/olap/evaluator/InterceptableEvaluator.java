 ...
 * (children of a calc, parent of a calc) in EvaluatorRoot.compiledExps.
 *
 *
 ...
 * (computed in the constructor, unfortunately) and EvaluatorRoot. This
 ...
 * @since October, 2010
 */
public class InterceptableEvaluator extends EvaluatorImpl {
     ...
     */
    public InterceptableEvaluator(EvaluatorRoot root) {
        super(root);
    }
     ...
     */
    private InterceptableEvaluator(EvaluatorRoot root, InterceptableEvaluator evaluator,
    ...
    protected EvaluatorImpl pushClone(List<List<Member>> aggregationList) {
        return new InterceptableEvaluator(root, this, aggregationList);
    }
