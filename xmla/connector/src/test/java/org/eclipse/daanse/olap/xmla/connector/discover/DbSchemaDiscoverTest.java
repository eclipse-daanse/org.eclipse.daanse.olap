...
class DbSchemaDiscoverTest {
    ...
    void dbSchemaCatalogs() {
        when(contexts.getContext(any())).thenReturn(Optional.of(context));
    ...
    void dbSchemaTables() {
        ...
        // The level tables carry the dimension-qualified hierarchy name, mondrian's
        // dimension.hierarchy convention the bridge used too.
