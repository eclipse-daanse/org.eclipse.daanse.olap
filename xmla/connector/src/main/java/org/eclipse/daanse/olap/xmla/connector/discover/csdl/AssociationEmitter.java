...
import org.eclipse.daanse.xmla.model.csdl.v2.bi.TState;
import org.eclipse.daanse.xmla.model.csdl.v2.edm.AssociationSetType;
import org.eclipse.daanse.xmla.model.csdl.v2.edm.EdmFactory;
import org.eclipse.daanse.xmla.model.csdl.v2.edm.EndType;
import org.eclipse.daanse.xmla.model.csdl.v2.edm.TAssociation;
import org.eclipse.daanse.xmla.model.csdl.v2.edm.TAssociationEnd;
import org.eclipse.daanse.xmla.model.csdl.v2.edm.TConstraint;
import org.eclipse.daanse.xmla.model.csdl.v2.edm.TMultiplicity;
import org.eclipse.daanse.xmla.model.csdl.v2.edm.TNavigationProperty;
import org.eclipse.daanse.xmla.model.csdl.v2.edm.TPropertyRef;
import org.eclipse.daanse.xmla.model.csdl.v2.edm.TReferentialConstraintRoleElement;

/**
 * The associations between the measures entity and each dimension entity.
 * <p>
 * CSDL expresses a cube's dimensionality as EDM associations with roles and
 * multiplicity; this writes them and the association sets that instantiate
 * them.
 */
public final class AssociationEmitter {
    ...
    public record RelationshipUsage(Dimension dimension, Optional<String> factForeignKeyColumn,
            Optional<String> dimensionKeyColumn, boolean active) {
    }
    ...
    public void emit(Cube cube, Dimension measuresDimension, RelationshipUsage usage) {
        ...
        String assocName = ctx.unique(
                fk != null ? factEntity + "_" + dimEntity + "_" + dimEntity + "_" + fk : factEntity + "_" + dimEntity);
        ...
        nav.getAny().add(BiPackage.eINSTANCE.getDocumentRoot_NavigationProperty(), BI.createTNavigationProperty());
    ...
    private Optional<String> lowestLevelKeyProperty(Dimension dimension) {
        ...
        return levels.stream().filter(l -> !l.isAll()).reduce((first, second) -> second)
