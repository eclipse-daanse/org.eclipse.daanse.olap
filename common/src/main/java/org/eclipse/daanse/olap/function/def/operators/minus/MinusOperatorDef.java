...
public class MinusOperatorDef extends AbstractFunctionDefinition {
    ...
    static FunctionMetaData functionMetaData = new FunctionMetaDataR(infixOperationAtom, "Subtracts two numbers.",
            DataType.NUMERIC, new FunctionParameterR[] { FunctionParameterR.param(DataType.NUMERIC, "Minuend").describedAs("Minuend"),
                    FunctionParameterR.param(DataType.NUMERIC, "Subtrahend").describedAs("Subtrahend") }).withTextKey("Minus.Operation").caption("Minus Operation");
