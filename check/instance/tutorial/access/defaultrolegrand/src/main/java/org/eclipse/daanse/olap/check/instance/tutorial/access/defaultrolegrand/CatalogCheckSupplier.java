 ...
 */
package org.eclipse.daanse.olap.check.instance.tutorial.access.defaultrolegrand;
...
public class CatalogCheckSupplier implements org.eclipse.daanse.olap.check.model.provider.CatalogCheckSupplier {
    ...
    public OlapCheckModel get() {
        ...
        model.setName("Daanse Tutorial - Access With Default Role Checks");
        model.setDescription("Comprehensive checks for Daanse Tutorial - Access With Default Role catalog - logistics and package delivery analysis");
