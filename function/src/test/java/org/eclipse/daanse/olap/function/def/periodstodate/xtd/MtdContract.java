...
public final class MtdContract {
    ...
    public static final FunctionContract CONTRACT = FunctionContract.of("Mtd")
            ...
            .edgeCaseMdx("month-level member",  "Mtd([Time].[All Time].[2023].[Q1].[Feb])")
            .edgeCaseMdx("member NULL",         "Mtd(NULL)")

            .value("Count(Mtd([Time].[All Time].[2023].[Q1].[Feb]))", "1")

            .dependsOn("Mtd([Time].[All Time].[2023].[Q1].[Feb])")
            .dependsOn("Mtd()", "[Time]")

            .resultStyle("Mtd([Time].[All Time].[2023].[Q1].[Feb])", MUTABLE_LIST, MUTABLE_LIST)
            .resultStyle("Mtd([Time].[All Time].[2023].[Q1].[Feb])", ITERABLE, MUTABLE_LIST)
            .independentMutableList("Mtd([Time].[All Time].[2023].[Q1].[Feb])")
