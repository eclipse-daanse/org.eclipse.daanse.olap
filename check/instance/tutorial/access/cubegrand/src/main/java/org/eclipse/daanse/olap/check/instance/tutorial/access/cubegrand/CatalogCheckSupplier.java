 ...
 */
package org.eclipse.daanse.olap.check.instance.tutorial.access.cubegrand;
...
public class CatalogCheckSupplier implements org.eclipse.daanse.olap.check.model.provider.CatalogCheckSupplier {
    ...
    public OlapCheckModel get() {
        ...
        model.setName("Daanse Tutorial - Access Cube Grand Checks");
        model.setDescription("Comprehensive checks for Access Cube Grand catalog - logistics and package delivery analysis");
