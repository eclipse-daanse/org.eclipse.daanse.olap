...
public class PowerFunDef  extends AbstractFunctionDefinition {
    ...
    static FunctionMetaData functionMetaData = new FunctionMetaDataR(atom, description,
            DataType.NUMERIC, new FunctionParameterR[] { FunctionParameterR.param(DataType.NUMERIC, "x").describedAs("x"), FunctionParameterR.param(DataType.NUMERIC, "y").describedAs("y") }).withTextKey("Power").caption("Power Function");
