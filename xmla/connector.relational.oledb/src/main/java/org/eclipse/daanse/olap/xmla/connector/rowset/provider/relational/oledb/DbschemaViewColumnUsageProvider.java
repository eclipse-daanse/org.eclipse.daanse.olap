...
/**
 * {@code DBSCHEMA_VIEW_COLUMN_USAGE}, as a whiteboard service — <strong>answering no rows
 * yet</strong>.
 * <p>
 * The columns a view is defined over. One of the OLE DB schema rowsets (Appendix B), which [MS-SSAS] does
 ...
 * knows.
 * <p>
 * <strong>To fill it</strong>, the catalog needs view metadata. The mapping model
...
public class DbschemaViewColumnUsageProvider implements RowsetProvider<ContextListSupplyer> {
