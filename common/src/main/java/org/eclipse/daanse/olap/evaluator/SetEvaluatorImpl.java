 ...
 */
public class SetEvaluatorImpl
    implements Evaluator.SetEvaluator, TupleList.PositionCallback
{

    private static final Logger LOGGER = LoggerFactory.getLogger(SetEvaluatorImpl.class);
    ...
    private void ensureList() {
        ...
        try {
            ...
            TupleIterable iterable =
                    (TupleIterable) rrer.evaluateExpression(
                        calc,
                        rrer.slicerEvaluator(), null);
