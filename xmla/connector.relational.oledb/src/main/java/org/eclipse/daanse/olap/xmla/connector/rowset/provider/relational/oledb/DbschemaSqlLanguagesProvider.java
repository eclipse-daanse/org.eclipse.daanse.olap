...
/**
 * {@code DBSCHEMA_SQL_LANGUAGES}, as a whiteboard service — <strong>answering no rows
 * yet</strong>.
 * <p>
 * The conformance levels and dialects the catalog supports. One of the OLE DB schema rowsets (Appendix B), which [MS-SSAS] does
 ...
 * knows.
 * <p>
 * <strong>To fill it</strong>, the catalog needs the dialect's SQL conformance, which the dialect knows. The mapping model
...
public class DbschemaSqlLanguagesProvider implements RowsetProvider<ContextListSupplyer> {
