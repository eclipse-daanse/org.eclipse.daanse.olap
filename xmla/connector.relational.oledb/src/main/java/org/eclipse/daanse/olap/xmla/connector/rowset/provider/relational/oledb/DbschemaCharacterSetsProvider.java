...
/**
 * {@code DBSCHEMA_CHARACTER_SETS}, as a whiteboard service — <strong>answering no rows
 * yet</strong>.
 * <p>
 * The character sets the catalog can use. One of the OLE DB schema rowsets (Appendix B), which [MS-SSAS] does
 ...
 * knows.
 * <p>
 * <strong>To fill it</strong>, the catalog needs the connection's character set, which the dialect knows. The mapping model
...
public class DbschemaCharacterSetsProvider implements RowsetProvider<ContextListSupplyer> {
