...
/**
 * {@code DBSCHEMA_VIEW_TABLE_USAGE}, as a whiteboard service — <strong>answering no rows
 * yet</strong>.
 * <p>
 * The tables a view is defined over. One of the OLE DB schema rowsets (Appendix B), which [MS-SSAS] does
...
public class DbschemaViewTableUsageProvider implements RowsetProvider<ContextListSupplyer> {
